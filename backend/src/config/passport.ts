      ...
      new GoogleStrategy(
        {
          ...
          callbackURL: process.env.GOOGLE_CALLBACK_URL || process.env.BACKEND_NODE_ENV === 'production' ? 'https://tapeutilsbk.octro.com/auth/google/callback' : 'http://localhost:8000/auth/google/callback'
        },
